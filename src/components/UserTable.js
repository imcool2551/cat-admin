    ...
    render() {
        return(
            <tr>
                ...
                <td>
                    <Button bsStyle="primary" bsSize="xsmall" onClick={() => {this.props.onEdit('edit', this.props.userId, this.props.nickname)}} className="usertable-edit" >수정</Button>
                    <Button bsStyle="danger" bsSize="xsmall" onClick={() => {this.props.onDelete('delete', this.props.userId)}}>삭제</Button>
                </td>
            </tr>
        )
    }
